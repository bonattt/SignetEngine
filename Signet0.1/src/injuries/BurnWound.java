...
public class BurnWound extends Wound {
	...
	private static final int[] HEALTH_DAMAGE = new int[]{0, 0, 1, 1, 3, 5, Integer.MAX_VALUE};
	private static final int[] STUND_DAMAGE = new int[]{0, 0, 0, 0, 0, 0, 0};
	private static final int[] FATIGUE_DAMAGE = new int[]{0, 0, 0, 0, 0, 0, 0};
	private static final int[] DAMAGE_RATE = new int[]{1, 1, 6000, 3000, 1000, 1000, 0};
	private static final int[] INST_HEALTH_DAMAGE = new int[]{0, 3, 6, 13, 25, 50, Integer.MAX_VALUE};
	private static final int[] INST_STUN_DAMAGE = new int[]{0, 0, 0, 0, 0, 0, 0};
	...
	private static final int[] CHANCE_OF_INFECTION = new int[]{0, 0, 20, 30, 80, 95, 0};
	private static final double[] PAIN = new double[]{0, 1, 2, 5, 0, 0, 0};
