...
public class Injuries {
	...
	public static Wound getBluntWound(int severity, BodyPart bodypart) {
		Wound wound = new Wound(severity, DamageType.BLUNT, BLUNT_NAMES, bodypart, BLUNT_HEALTH_DAMAGE,
	...
	public static Wound getBurnWound(int severity, BodyPart bodypart) {
		Wound wound = new Wound(severity, DamageType.FIRE, BURN_NAMES, bodypart, BURN_HEALTH_DAMAGE,
	...
	public static Wound getStabWound(int severity, BodyPart bodypart) {
		Wound wound = new Wound(severity, DamageType.PIERCING, STAB_NAMES, bodypart, STAB_HEALTH_DAMAGE,
	...
	public static Wound getSlashingWound(int severity, BodyPart bodypart) {
		Wound wound = new Wound(severity, DamageType.SLASHING, SLASHING_NAMES, bodypart, SLASHING_HEALTH_DAMAGE,
	...
	public static Wound getNewWound(int severity, int damageType, BodyPart bodypart) {
		...
		if (damageType == DamageType.SLASHING){
			wound = Injuries.getSlashingWound(severity, bodypart);
		} else if (damageType == DamageType.BLUNT) {
			wound = Injuries.getBluntWound(severity, bodypart);
		} else if (damageType == DamageType.PIERCING) {
			wound = Injuries.getStabWound(severity, bodypart);
		} else if (damageType == DamageType.FIRE) {
			wound = Injuries.getBurnWound(severity, bodypart);
		} else {
